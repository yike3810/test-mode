<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"F:\project\pointsmall\public/../application/admin\view\order\delivery_edit.html";i:1640144822;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['form', 'layedit'], function(){
        ...
        form.on('submit(member_subit)', function (data) {
            console.log()
            $.ajax({
                url: "<?php echo url('Order/delivery_edit_do'); ?>",
                dataType: 'json',
                type: 'POST',
                data: data.field,

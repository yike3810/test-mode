<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"F:\project\pointsmall\public/../application/index\view\newslist\index.html";i:1640157030;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
                    ...
                    <van-row>
                        <div class="exchange_node">
                            <van-col span="22" offset="1">
                                ...
                                <span class="red_text" v-if="[1,0].includes(item.order_status) && [0].includes(item.shipping_status) ">待发货</span>
                                <span class="red_text" v-if="[1].includes(item.order_status) && [1].includes(item.shipping_status)">待收货</span>
    ...
    var list = new Vue({
        ...
        methods: {
            onLoad: function () {
                ...
                axios.post("<?php echo url('Newslist/getrecordlist'); ?>", json)
                    .then((res) => {

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"F:\project\pointsmall\public/../application/admin\view\news\tree.html";i:1636941641;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
        ...
        var inst1 = tree.render({
		  ...
		  click: function(obj){
              ...
              layui.use('table', function(){
			    	  ...
			    	  table.render({
			    	    elem: '#demo'
			    	    ,url: "<?php echo url('News/getNewsList'); ?>" //数据接口
    		  ...
    		  if(layEvent === 'detail'){        console.log(obj.data);
                ...
                if(obj.data.type==1){
                  ...
                  layer.open({
                      ...
                      maxmin: true, //开启最大化最小化按钮
                      area: ['90%', '90%'],
                      content: "<?php echo url('News/view_record_list'); ?>?news_id="+news_id
                  });

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"F:\project\pointsmall\public/../application/admin\view\system\ip.html";i:1640144824;}*/ ?>
    ...
    <script>
        ...
        layui.use('table', function () {
            ...
            table.render({
                ...
                , url: "<?php echo url('System/getip_list'); ?>" //数据接口
                , page: true //开启分页
                , limit: 15
            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'edit') {
                    ...
                    layer.open({
                        ...
                        area: ['60%', '60%'],
                        content: "<?php echo url('System/edit'); ?>?id=" + id
                    });
                } else if (layEvent === 'del') {
                    layer.confirm('确定要删除该封锁IP吗？', function (index) {
                        var ID = obj.data.ID;
                        $.ajax({
                            url: "<?php echo url('System/del'); ?>",
                            dataType: 'json',
                            type: 'POST',
                            data: 'ID=' + ID,
        ...
        function bindTableToolbarFunction() {
            ...
            $('#add').on("click", function () {
                ...
                layer.open({
                    ...
                    fixed: false, //不固定
                    maxmin: true,
                    content: "<?php echo url('System/ipadd'); ?>?ID=",
                    cancel: function () {
                        table.reload('system', {});
                    }
                });

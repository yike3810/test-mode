<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"F:\project\pointsmall\public/../application/admin\view\order\pending.html";i:1644288648;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="layui-fluid">
    ...
    <script>
        layui.use([ 'form','table'], function(){
            ...
            table.render({
                ...
                ,url: "<?php echo url('Order/getpendinglist'); ?>" //数据接口
                ,page: true //开启分页
                ,limit:15
            ...
            table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'del'){ //删除
                    ...
                    //编辑
                    var url = "<?php echo url('pending_edit'); ?>?order_id="+obj.data.order_id;
                    layer.open({
                        type: 2,
                        title:'修改订单信息',
                        area: ['55%', '70%'],
                    ...
                    layer.confirm('确定要审核该订单吗', function(index){
                        layer.close(index);
                        var order_id = obj.data.order_id;
                        $.ajax({
                            url:"<?php echo url('examine_do'); ?>",
                            dataType:'json',
                            type:'POST',
                            data:'order_id='+order_id,
                            success: function(data) {
    ...
    <script type="text/html" id="barDemo">
        ...
        <a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="examine">审核</a>

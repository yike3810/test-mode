<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"F:\project\consumer-coupon\public/../application/admin\view\commodity\index.html";i:1675820828;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <script>
        layui.use([ 'form','table'], function(){
            ...
            function bindTableToolbarFunction() {
                ...
                $('#add').on("click", function () {
                    ...
                    layer.open({
                        ...
                        fixed: false, //不固定
                        maxmin: true,
                        content: "<?php echo url('Commodity/addcommodity'); ?>?commodity_id=",
                        cancel: function () {
            ...
            table.render({
                ...
                ,url: "<?php echo url('Commodity/getCommodityList'); ?>" //数据接口
                ,page: true //开启分页
                ,limit:15
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'contact', title: '商家联系人', width:130}
            ...
            table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'del'){ //删除
                    ...
                    //编辑
                    var url = "<?php echo url('Commodity/edit'); ?>?id="+obj.data.id;
                    layer.open({
                        type: 2,
                        title:'修改商家信息',
                        area: ['75%', '90%'],

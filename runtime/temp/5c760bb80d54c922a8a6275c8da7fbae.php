<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"F:\project\pointsmall\public/../application/admin\view\operating\index.html";i:1636941641;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<div class="layui-fluid">
    ...
    <script>
        ...
        layui.use('table', function(){
            ...
            table.render({
                elem: '#demo'
                ,url: "<?php echo url('Operating/getOperating_List'); ?>" //数据接口
                ,page: true //开启分页
            ...
            table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'detail'){ //查看
                    ...
                    layer.confirm('确定要删除该数据吗？', function (index) {
                        ...
                        var ID = obj.data.ID;
                        $.ajax({
                            url: "<?php echo url('Operating/del'); ?>",
                            dataType: 'json',
                            type: 'POST',
                            data: 'ID=' + ID,
                            success: function (data) {

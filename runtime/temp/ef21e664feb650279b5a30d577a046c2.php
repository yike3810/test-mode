<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"F:\project\pointsmall\public/../application/admin\view\module\module.html";i:1640144824;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <script>
        ...
        layui.use('table', function () {
            ...
            function bindTableToolbarFunction() {
                ...
                $('#moduleadd').on("click", function () {
                    ...
                    layer.open({
                        ...
                        fixed: false, //不固定
                        maxmin: true,
                        content: "<?php echo url('Module/module_add'); ?>?ID=",
                        cancel: function () {
                            table.reload('module', {});
                        }
                    });
            ...
            table.render({
                ...
                , url: "<?php echo url('Module/getModule_list'); ?>" //数据接口
                , page: false //开启分页
                , limit: 90
            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'moduleedit') {
                    ...
                    layer.open({
                        ...
                        area: ['70%', '70%'],
                        content: "<?php echo url('Module/module_edit'); ?>?ID=" + ID,
                        end:function () {
                            table.reload('module', {});
                        }
                    });
                    ...
                    layer.confirm('确定要删除该模块吗？', function (index) {
                        var ID = obj.data.ID;
                        $.ajax({
                            url: "<?php echo url('Module/moduledel'); ?>",
                            dataType: 'json',
                            type: 'POST',
                            data: 'ID=' + ID,

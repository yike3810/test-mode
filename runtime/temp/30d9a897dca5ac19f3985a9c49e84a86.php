<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"F:\project\pointsmall\public/../application/admin\view\order\delivery.html";i:1644288648;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script>
        layui.use([ 'form','table'], function(){
            ...
            table.render({
                ...
                ,url: "<?php echo url('Order/getdeliverylist'); ?>" //数据接口
                ,page: true //开启分页
                ,limit:15
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'member_name', title: '会员名', width:150}
            ...
            table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'del'){ //删除
                    ...
                    //编辑
                    var url = "<?php echo url('delivery_edit'); ?>?order_id="+obj.data.order_id;
                    layer.open({
                        type: 2,
                        title:'修改订单信息',
                        area: ['55%', '70%'],
                ...
                }else if(layEvent === 'deliver_goods'){
                    //发货

                    var url = "<?php echo url('order_fahuo'); ?>?order_id="+obj.data.order_id;
                    layer.open({
                        type: 2,
                        title:'查看订单详情',
                        area: ['40%', '40%'],
...
<!--        <a class="layui-btn layui-btn-danger layui-btn-xs"  lay-event="del">删除</a>-->
        ...
        <a class="layui-btn layui-btn-danger layui-btn-xs"  lay-event="deliver_goods">发货</a>
    </script>
</div>
</body>
</html>
<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"F:\project\consumer-coupon\public/../application/admin\view\index\index.html";i:1675388660;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	...
	$('.button').click(function(event) {
		...
		$.ajax({
			...
			success: function(data) {
                if (data.s=='ok') {
                    wintq('登录成功',1,2000,0,"<?php echo url('index/main'); ?>");
                }else {

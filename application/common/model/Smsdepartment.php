...
use Cassandra\Date;
class Smsdepartment extends \think\Model
{
    protected $name = 'sms_department_queue';
    protected $auto = [];
    protected $insert = [];
    protected $update = [];
    //添加当前时间
    ...
    //验证和发送操作
    public function Smssendmessage ($phone) {
...
//            a($data['phone']);
            ...
            $data['template_id']    = '2aabe499df52441182c9e6b523a3dbae';
...
//            发送短信后更新 $data['send_status'] | 0未发送，1发送成功，2发送失败
            $TEMPLATE_ID = '2aabe499df52441182c9e6b523a3dbae'; //模板ID
...
//            $TEMPLATE_PARAS = "['{$data['verification_code']}']"; //模板变量，根据自身使用的模板，其值长度和个数与模板对应
            $TEMPLATE_PARAS = '[]';
            $sender 	= "8820113028670";
            $status_arr = sendSms($receiver,$TEMPLATE_ID,$TEMPLATE_PARAS,$sender);
//            模拟提交
